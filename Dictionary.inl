...
void Dictionary<T1, T2>::createArr(T1*& const arrKey, T2*& const arrValue, const int& length, const bool& flag)
{
	if (flag)
...
template <typename T1, typename T2>
void Dictionary<T1, T2>::fillArr(T1*& const arrKey, T2*& const arrValue, const bool& flag)
{
	flag ? arrKey[this->length] = this->key : arrValue[this->length] = this->value;
}

template<typename T1, typename T2>
void Dictionary<T1, T2>::copyArr(T1*& const arrKey1, T1*& const arrKey2, T2*& const arrValue1, T2*& const arrValue2, const bool& flag)
{
	if (flag) {
...
template <typename T1, typename T2>
void Dictionary<T1, T2>::cleanArr(T1*& const arr1, T2*& const arr2, const bool& flag)
{
	if (flag) {
		delete[] arr1;
		arr1 = nullptr;
...
template<typename T1, typename T2>
void Dictionary<T1, T2>::createDict(T1*& const arrKey, T2*& const arrValue, const int& length, const bool& flag)
{
...
template <typename T1, typename T2>
T1* Dictionary<T1, T2>::getKey() const {
	return this->arrKey;
}

template <typename T1, typename T2>
T2* Dictionary<T1, T2>::getValue() const {
	return this->arrValue;
}

template <typename T1, typename T2>
void Dictionary<T1, T2>::setKey(const T1& key) {
	this->key = key;
}

template <typename T1, typename T2>
void Dictionary<T1, T2>::setValue(const T2& value) {
	this->value = value;
}
